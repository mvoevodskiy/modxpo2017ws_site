...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('modxpo2017ws_site_core_path', null,
                    $modx->getOption('core_path') . 'components/modxpo2017ws_site/') . 'model/';
            $modx->addPackage('modxpo2017ws_site', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/modxpo2017ws_site/model/schema/modxpo2017ws_site.mysql.schema.xml';
