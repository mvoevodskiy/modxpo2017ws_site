<?php
/**
 * Rename script for modxpo2017ws_site
 *
    ...
    foreach ($items as $item) {
        ...
        if (is_dir($new_path)) {
            ...
            if ($item == 'home.class.php') {
                $content = str_replace($replace[0] . 'ManagerController', 'modxpo2017ws_siteManagerController', $content);
            }
